    ...
    <section id="contact" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            { icon: MapPin, label: "Address", value: "Safe Sky Kitchen, Pillar Number, Before Red Light, E-1, 367, Main Road, Block E, Bali Nagar, New Delhi, Delhi — 110015", href: "https://www.google.com/maps/search/Safe+Sky+Kitchen+Bali+Nagar+Rajouri+Garden+New+Delhi" },
        ...
        >
          <a
            href="https://www.google.com/maps/search/Safe+Sky+Kitchen+Bali+Nagar+Rajouri+Garden+New+Delhi"
            target="_blank"
          ...
          >
            <iframe
              ...
              width="100%"
              height="350"
              style={{ border: 0, filter: "invert(90%) hue-rotate(180deg) brightness(0.95) contrast(0.9)", pointerEvents: "none" }}
              allowFullScreen
              loading="lazy"
